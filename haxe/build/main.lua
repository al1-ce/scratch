...
__lua_Thread = _hx_e()
__src__Main_Main_Fields_ = _hx_e()
__std__Io_Io_Fields_ = _hx_e()
...
__src__Main_Main_Fields_.new = {}
__src__Main_Main_Fields_.__name__ = true
__src__Main_Main_Fields_.main = function() 
  __std__Io_Io_Fields_.println("");
end

__std__Io_Io_Fields_.new = {}
__std__Io_Io_Fields_.__name__ = true
__std__Io_Io_Fields_.println = function(text) 
